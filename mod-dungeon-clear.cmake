...
if (BUILD_TESTING)
    function(define_dungeon_clear_tests)
        ...
        add_executable(dungeon_clear_tests
            ...
            "${MOD_PATH}/t/TestTestRaidRegistry.cpp"
            "${MOD_PATH}/t/TestRaidLaunchRequest.cpp"
            "${MOD_PATH}/t/TestRaidRequestGateway.cpp"
            "${MOD_PATH}/t/TestRaidEngineValidation.cpp"
            "${MOD_PATH}/t/TestRaidRosterReservation.cpp"
            "${MOD_PATH}/t/TestRaidLaunchAdmission.cpp"
            ...
            "${MOD_PATH}/t/TestDungeonClearController.cpp"
